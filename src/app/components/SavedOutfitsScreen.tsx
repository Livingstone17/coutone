  ...
  return (
    <div className="min-h-screen bg-[var(--bg-primary)] flex flex-col">
      ...
      <div className="bg-[var(--bg-secondary)] border-b border-[var(--border-color)] px-4 py-4">
        ...
        <h2 className="text-xl text-[var(--text-primary)]">Saved Outfits</h2>
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-4">
        {savedOutfits.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full text-center px-6 -mt-20">
            ...
            <h3 className="text-xl text-[var(--text-primary)] mb-2">No saved outfits yet</h3>
          ...
          <div className="grid grid-cols-2 gap-4 pb-4">
            {savedOutfits.map((outfit, idx) => (
              <button
                ...
                className="bg-[var(--bg-secondary)] rounded-2xl p-4 shadow-sm hover:shadow-md transition-all active:scale-95"
              >
                {/* Mini Silhouette */}
                ...
                <div className="flex gap-1 justify-center mb-2">
                  <div
                    className="w-5 h-5 rounded-md border border-[var(--border-color)]"
                    style={{ backgroundColor: outfit.top.color }}
                  />
                  <div
                    className="w-5 h-5 rounded-md border border-[var(--border-color)]"
